"""create projects, assets, chunks tables

Revision ID: 945dab126b29
Revises:
Create Date: 2026-07-19 03:14:35.815499
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "asset_config", postgresql.JSONB(astext_type=sa.Text()), nullable=True
        ),
